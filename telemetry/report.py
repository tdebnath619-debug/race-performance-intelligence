"""telemetry/report.py — JSON and CSV report export."""
import json, csv
import numpy as np
...
def save_report(lap_metrics, comparison_report=None, out_dir="reports", stem="analysis"):
    ...
    report={"system":"Motorsport Telemetry v2","lap":lap_metrics.to_dict()}
    if comparison_report: report["comparison"]=comparison_report.to_dict()
